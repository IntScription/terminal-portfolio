...
function Callout({
  ...
  const styles = {
    default:
      "border-[rgba(var(--border))] bg-white/50 dark:bg-white/5",
    info:
...
export const mdxComponents: MDXComponents = {
  ...
  ul: (props) => (
    <ul className="mt-4 list-disc space-y-2 pl-6 text-[15px] leading-8 text-foreground/78" {...props} />
  ),
  ol: (props) => (
    <ol className="mt-4 list-decimal space-y-2 pl-6 text-[15px] leading-8 text-foreground/78" {...props} />
  ),
